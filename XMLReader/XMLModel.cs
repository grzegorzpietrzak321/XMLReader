...
namespace XMLManager
{
    ...
    public class ExportData
    {
        ...
        private BuildingNodeses _buildingNodesField;

        [XmlElement("BuildingNodes")]
        public BuildingNodeses buildingNodes
        {
            get { return this._buildingNodesField; }
            set { this._buildingNodesField = value; }
        }
